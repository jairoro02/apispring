...
public class Seeder implements CommandLineRunner {
    ...
    public void run(String... args){
        ...
        Heroe superman = new Heroe(universes.get(1), "Superman", "I am Superman, the Last Son of Krypton. With my incredible powers, I protect Earth from any threat. I stand for truth, justice, and the American way.", 0, "Male", "https://i.ibb.co/fMx9gdy/Superman.webp");
        heroes.add(superman);
        ...
        Heroe captainAmerica = new Heroe(universes.get(0), "Captain America", "I am Captain America, a symbol of justice and patriotism. With my shield in hand, I fight for freedom and protect the innocent from any threat to our great nation.", 0, "Male", "https://i.ibb.co/DrQxKFd/Marvel-Now-Cap.webp");
        ...
        Heroe thor = new Heroe(universes.get(0), "Thor", "I am Thor, the God of Thunder. With my mighty hammer Mjolnir, I protect the realms from evil forces. As an Asgardian, I bring strength and lightning to those who oppose me.", 0, "Male", "https://i.ibb.co/F4XD7gW/Classic-Thor.webp");
        heroes.add(thor);

        Heroe aquaman = new Heroe(universes.get(1), "Aquaman", "I am Aquaman, the king of Atlantis. With my ability to communicate with sea creatures and command the oceans, I defend the underwater realm and protect the surface world.", 0, "Male", "https://i.ibb.co/3185wgC/Aquaman.webp");
        heroes.add(aquaman);
        ...
        Heroe greenLantern = new Heroe(universes.get(1), "Green Lantern", "I am Green Lantern, a member of the Green Lantern Corps. With my power ring fueled by willpower, I patrol the universe and protect it from all threats. In brightest day, in blackest night.", 0, "Male", "https://i.ibb.co/kmPB8z5/Hal-Jordan-GL.webp");
        ...
        Villano venom = new Villano(universes.get(0), "Venom", "I am Venom, an alien symbiote thirsty for power and chaos. My dark nature drives me to dominate my enemies and consume their life force. No one can escape my immense power and ferocity. Prepare to face your worst nightmare.", 0, "Male", "https://i.ibb.co/KWHHYZx/Venom.webp", spiderman);
        villanos.add(venom);

        Villano joker = new Villano(universes.get(1), "Joker", "Ha ha ha! I am the Joker, the Clown Prince of Crime! My chaotic antics and twisted sense of humor will drive you to the brink of madness. Prepare for a night of chaos and mayhem, Batman!", 0, "Male", "https://i.ibb.co/TqNrd3t/Joker.png", batman);
        villanos.add(joker);

        Villano thanos = new Villano(universes.get(0), "Thanos", "I am Thanos, the Mad Titan. With the power of the Infinity Gauntlet, I seek to bring balance to the universe by wiping out half of all life. Your attempts to stop me are futile. Prepare to face the inevitability of your own destruction.", 0, "Male", "https://i.ibb.co/2688V7v/thanos-marvel-comics-render-by-egg84-df4u9iw-fullview.png", ironman);
        villanos.add(thanos);
        ...
        Villano darkseid = new Villano(universes.get(1), "Darkseid", "I am Darkseid, the ruler of Apokolips and the embodiment of tyranny! My ultimate goal is to conquer the universe and bend all to my will. Prepare to kneel before me, Justice League!", 0, "Male", "https://i.ibb.co/kxdbszw/Darkseid-New52-Render.webp", superman);
